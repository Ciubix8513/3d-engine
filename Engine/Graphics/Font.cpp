...
bool Font::Init(ID3D11Device* device,ID3D11DeviceContext* ctxt, char* fontFile, char* fontTexture)
{
    bool result;
...
bool Font::LoadFontData(char* file)
{
    ifstream fin;
    char tmp;
    ...
    numChars = count(istream_iterator<char>(fin), istream_iterator<char>(), '\n');
    numChars++;
    fin.close();*/
